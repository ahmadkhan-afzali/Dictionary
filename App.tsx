import { StyleSheet, Text, View, Image, Button, TouchableOpacity, Alert, Pressable, TouchableHighlight, SafeAreaView } from 'react-native'
...
const App = () => {
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Text style={{ color: "#bbc", fontSize: 30, fontWeight: "bold" }}> Wecome to My page</Text>
      ...
      <Button title='submit here' onPress={() => Alert.alert("submitted")}></Button>

      <TouchableOpacity style={{ backgroundColor: "red", padding: 10, }} onPress={() => Alert.alert("pressed")}>
        <Text style={{ color: "white" }}> Button</Text>
      </TouchableOpacity>

      <TouchableHighlight style={{ backgroundColor: "red", padding: 10 }} onPress={() => Alert.alert("pressed")}>
        <Text> Button</Text>
      </TouchableHighlight>


      <Pressable style={{ padding: 10, backgroundColor: "yellow" }} onPress={() => Alert.alert("clicked")}>
